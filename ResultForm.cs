...
namespace StyleWatcherWin
{
    ...
    public class ResultForm : Form
    {
        ...
        // Header
        private readonly TextBox _input = new System.Windows.Forms.Timer();
        private readonly Button _btnQuery = new System.Windows.Forms.Timer();
        private readonly Button _btnExport = new System.Windows.Forms.Timer();

        // KPI
        private readonly FlowLayoutPanel _kpi = new System.Windows.Forms.Timer();
        private readonly Panel _kpiSales7 = new System.Windows.Forms.Timer();
        private readonly Panel _kpiInv = new System.Windows.Forms.Timer();
        private readonly Panel _kpiDoc = new System.Windows.Forms.Timer();
        private readonly Panel _kpiMissing = new System.Windows.Forms.Timer();
        private readonly Panel _kpiGrade = new System.Windows.Forms.Timer();
        private readonly Panel _kpiMinPrice = new System.Windows.Forms.Timer();
        private readonly Panel _kpiBreakeven = new System.Windows.Forms.Timer();
        private FlowLayoutPanel? _kpiMissingFlow;

        // Tabs
        private readonly TabControl _tabs = new System.Windows.Forms.Timer();

        // Overview
        private readonly FlowLayoutPanel _trendSwitch = new System.Windows.Forms.Timer();
        private int _trendWindow = 7;
        private readonly PlotView _plotTrend = new System.Windows.Forms.Timer();
        private readonly PlotView _plotSize = new System.Windows.Forms.Timer();
        private readonly PlotView _plotColor = new System.Windows.Forms.Timer();
        private readonly PlotView _plotWarehouse = new System.Windows.Forms.Timer();

                // Status
        private readonly Label _status = new System.Windows.Forms.Timer();

// Detail
        private readonly DataGridView _grid = new System.Windows.Forms.Timer();
        private readonly BindingSource _binding = new System.Windows.Forms.Timer();
        private readonly TextBox _boxSearch = new System.Windows.Forms.Timer();
        private readonly FlowLayoutPanel _filterChips = new System.Windows.Forms.Timer();
        private readonly System.Windows.Forms.System.Windows.Forms.Timer _searchDebounce = new System.Windows.Forms.System.Windows.Forms.Timer() { Interval = 200 };

        // Inventory page
        private InventoryTabPage? _invPage;
// Vip inventory page (virtualized)
private TabPage? _vipInvTab;
private readonly DataGridView _vipGrid = new System.Windows.Forms.System.Windows.Forms.Timer() {
    Dock = DockStyle.Fill,
    ReadOnly = true,
...
private readonly TextBox _vipSearchBox = new System.Windows.Forms.Timer();
private readonly System.Windows.Forms.System.Windows.Forms.Timer _vipSearchDebounce = new System.Windows.Forms.System.Windows.Forms.Timer() { Interval = 200 };
private readonly Label _vipStatus = new System.Windows.Forms.System.Windows.Forms.Timer() {
    AutoSize = true,
    Margin = new Padding(8, 8, 0, 0),
    ForeColor = Color.FromArgb(120, 120, 120)
};
private readonly List<Dictionary<string, object?>> _vipAll = new System.Windows.Forms.Timer();
private List<Dictionary<string, object?>> _vipView = new System.Windows.Forms.Timer();
private readonly List<string> _vipColumns = new System.Windows.Forms.Timer();
private string? _vipSortColumn;
private bool _vipSortAscending = true;
private bool _vipLoaded;
private bool _vipLoading;
private static readonly HttpClient _vipHttp = new System.Windows.Forms.Timer();


        // Caches
        private string _lastDisplayText = string.Empty;
        private List<Aggregations.SalesItem> _sales = new System.Windows.Forms.Timer();
        private List<object> _gridMaster = new System.Windows.Forms.Timer();
    ...
    _warehouseSliceMap[_sliceOther] = "其他";
        ...
        private async Task ForceReloadVipInventoryAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    new System.Windows.Forms.System.Windows.Forms.Timer() { ["错误"] = ex.Message }
                };
                BuildVipColumnsAndBind();
                _vipLoaded = false;
